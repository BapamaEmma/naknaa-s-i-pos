        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantValue = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    CostPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    SellingPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ReorderLevel = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_service_jobs_services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_service_jobs_users_AssignedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bin = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_inventory_records_warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_purchase_items_product_variants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "product_variants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_sale_items_product_variants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "product_variants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_inventory_records_ProductVariantId_WarehouseId_Section_Rack~",
                table: "inventory_records",
                columns: new[] { "ProductVariantId", "WarehouseId", "Section", "Rack", "Bin" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_inventory_records_WarehouseId",
                table: "inventory_records",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_inventory_transactions_CreatedAt",
                table: "inventory_transactions",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_inventory_transactions_ReferenceNumber",
                table: "inventory_transactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_product_variants_ProductId_VariantName_VariantValue",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_purchase_items_ProductVariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sale_items_ProductVariantId",
                table: "sale_items",
                column: "ProductVariantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_service_jobs_AssignedUserId",
                table: "service_jobs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_service_jobs_JobNumber",
                table: "service_jobs",
                column: "JobNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_service_jobs_ServiceId",
                table: "service_jobs",
                column: "ServiceId");
